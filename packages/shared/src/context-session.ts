...
export interface AgentContextRequest { query: string; requestedSymbols?: string[]; requestedPaths?: string[]; requestedCoverage?: ContextCoverageCategory[]; }
export type ContextControlSignal = ({ type: "agent_context_request" } & AgentContextRequest) | { type: "test_failure"; failingTests: string[]; errorSummary: string; relatedPaths?: string[]; relatedSymbols?: string[] } | { type: "missing_coverage"; categories: ContextCoverageCategory[] } | { type: "out_of_scope_modification"; modifiedPaths: string[]; predictedPaths: string[] };
